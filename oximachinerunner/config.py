...
ASSETS_DIR = os.path.join(LIB_DIR, 'assests')
...
MODEL_CONFIG = {
    'all_20200830': {
        'scaler': {
            ...
            'url': 'https://www.dropbox.com/s/qz8c06iupx7cy5h/scaler.joblib?dl=0',
            'path': os.path.join(ASSETS_DIR, 'all_202000830', 'scaler.joblib')
        },
        'classifier': {
            'md5': 'dc0dc74b860878a53fd0f5edf5d1ba57',
            'url': 'https://www.dropbox.com/s/lc2z4abaycjbbe1/classifier.joblib?dl=0',
    ...
    'mof_chemarxiv': {
        'scaler': {
            ...
            'url': 'https://www.dropbox.com/s/e2x0oqo4id61iff/scaler.joblib?dl=0',
            'path': os.path.join(ASSETS_DIR, 'mof_chemarxiv', 'scaler.joblib')
        },
        'classifier': {
            'md5': '2fee4c35f475fa2f8123e7451f6a2f74',
            'url': 'https://www.dropbox.com/s/jr22xflk5qeddcy/classifier.joblib?dl=0',
