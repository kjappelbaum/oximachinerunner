...
class OxiMachineWidget(ipw.VBox):
    ...
    def run_oximachine(self, _=None):
        ...
        self.output.value = (
            """<i class="fa fa-spinner fa-pulse" style="color:red;" ></i>"""
        )
        try:
            ...
            (
                ...
                metal_indices,
                _,
            ) = self.runner._featurize_single(  # pylint:disable=protected-access,invalid-name
                structure
            )  # pylint:disable=invalid-name
            predictions = self.runner._make_predictions(
                X
