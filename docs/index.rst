...
Welcome to oximachinerunner's documentation!
============================================
...
It also provides a basic ipython widget, that is used in [AiiDA lab](https://aiidalab.materialscloud.org/hub/login).
